...
switch($str)
{
	...
	case 'sandbox' : 	
		//===========<Sandbox - Fill out consumerKey(APP_KEY), secret(APP_SECRET), oauth access token & secret below>============
		setConst('ETWS_APP_KEY',			'9029864038ac4e1e42105241a95613a7');
		setConst('ETWS_APP_SECRET',			'dcbc924bfb5c15e80ee7b45e14c5294c');
		setConst('ETRADE_OAUTH_SERVER', 	'https://etws.etrade.com');
		setConst('AUTHORIZE_URL',			'https://us.etrade.com/e/t/etws/authorize');
		setConst('ETRADE_SERVER', 			'https://etwssandbox.etrade.com');
		// These last two were pulled from a ruby app that originally made access token
		setConst('OAUTH_ACCESS_TOKEN',		'JMjtC8tVecH7iyHK45YZuAl5LdWuv4+6egc90jXz20k=');
		setConst('OAUTH_ACCESS_TOKEN_SECRET','DvqdQbMo2v6tuNjBTo1/K8Kb6gS6qX6iBHEsO8k4PGI=');
